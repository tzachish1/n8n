 ...
 * `AddOidcSeedSourceToCredentialResolver1784000000007`, or
 * `AddOidcSeedSourceToCredentialResolver1784000000022`), the `up()` records
 * a no-op so the migrations table can advance to the renamed entry without
 * re-running the DDL. The renumber to `…1784000000029` was needed because
 * upstream n8n added common migrations through `…027` plus the postgres-only
 * `AddProjectIdToInstanceAiThread1784000000028` during the 2.25.7 → 2.26.8
 * upgrade, colliding with the prior `…022`.
 */
export class AddOidcSeedSourceToCredentialResolver1784000000029 implements ReversibleMigration {
