...
import Akeyless from '../../externalSecrets.ee/assets/images/akeyless.svg';
...
<template>
	<Akeyless v-if="provider.type === 'akeyless'" />
	<AwsSecretsManager v-else-if="provider.type === 'awsSecretsManager'" />
